/**
 * This is the image converter tools/image/converter/convertSERToQuoc.cpp rewritten as a
 * header file so that it can be included directly in the program for exit wave reconstruction
 * 
 * Original documentation of the image converter:
 * 
 * \file
...
void convertSERToQuoc ( const string& ser_file_input, const string& quoc_file_output ) {
  try {
    const string inFileName = ser_file_input;
